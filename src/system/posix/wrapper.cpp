...
lak::posix::result<int> lak::posix::mprotect(void *address, size_t length, int protect)
{
...
lak::posix::result<int> lak::posix::madvise(void *address, size_t length, int advise)
{
