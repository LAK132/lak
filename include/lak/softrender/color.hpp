#ifndef LAK_SOFTRENDER_COLOR_HPP
#define LAK_SOFTRENDER_COLOR_HPP
...
inline value8_t operator%(const alpha8_t &, value8_t rhs) { return rhs; }

inline color16_t operator%(const alpha8_t &, color16_t rhs) { return rhs; }

inline color24_t operator%(const alpha8_t &, color24_t rhs) { return rhs; }
...
inline value8_t operator%(const value8_t &, value8_t rhs) { return rhs; }

inline color16_t operator%(const value8_t &, color16_t rhs) { return rhs; }

inline color24_t operator%(const value8_t &, color24_t rhs) { return rhs; }
...
inline value8_t operator%(const color16_t &, value8_t rhs) { return rhs; }

inline color16_t operator%(const color16_t &, color16_t rhs) { return rhs; }

inline color24_t operator%(const color16_t &, color24_t rhs) { return rhs; }
...
inline value8_t operator%(const color24_t &, value8_t rhs) { return rhs; }

inline color16_t operator%(const color24_t &, color16_t rhs) { return rhs; }

inline color24_t operator%(const color24_t &, color24_t rhs) { return rhs; }
...
inline value8_t operator%(const color32_t &, value8_t rhs) { return rhs; }

inline color16_t operator%(const color32_t &, color16_t rhs) { return rhs; }

inline color24_t operator%(const color32_t &, color24_t rhs) { return rhs; }
